...
```{r, results="asis"}
d = read_rds("C:/Users/windows/Desktop/R/DaSPPA_Portfolio/Lec 10 Note/data_ce_speech_article.rds")
...
Up next, we discuss methods to remove 1certain patterins from a string or replace a pattern with another pattern. Specifically, we will discuss the following functions:
