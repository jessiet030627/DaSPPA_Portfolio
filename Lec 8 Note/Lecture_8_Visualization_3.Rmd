...
d <- readRDS("C:/Users/windows/Desktop/R/DaSPPA_Portfolio/wealth_and_health.rds")
d |> print(n = 3)
```
...
d <- d |>
  mutate(
    region = case_match(
      region,
      1 ~ "Western Europe", 2 ~ "Notehrn Europe", 3 ~ "Southern Europe",
...
d|> group_by()|> count()|>ungroup()|> mutate(prop = n/sum(n))
```
